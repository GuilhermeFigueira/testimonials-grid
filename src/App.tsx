...
function App() {
	return (
		<div className="flex flex-col items-center gap-8 h-fit py-20 w-screen bg-blue-gray grid_testimonial">
			<div className="xl:[grid-row:1/1] xl:[grid-column:1/3]">
				<Testimonial
					bgPattern={true}
					color={"violet"}
					name={"Daniel"}
			...
			<div className="xl:[grid-row:1/1] xl:[grid-column:3/4]">
				<Testimonial
			...
			<div className="xl:[grid-row:2/2] xl:[grid-column:1/2]">
				<Testimonial
					color={"white"}
					name={"Jeanette"}
					lastName={"Harmon"}
			...
			<div className="xl:[grid-row:2/2] xl:[grid-column:2/4]">
				<Testimonial
					color={"blue-dark_black"}
					name={"Patrick"}
					lastName={"Abrams"}
					job={"Verified Graduate"}
					title={
			...
			<div className="xl:[grid-row:1/3] xl:[grid-column:4/5]">
				<Testimonial
					color={"white"}
					name={"Kira"}
					lastName={"Whittle"}
